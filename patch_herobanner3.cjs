...
if (startIdx !== -1 && endIdx !== -1) {
  ...
  // Fix up the references to HeroBanner props
  code = code.replace(/heroMovie=\{heroMovies\}/g, 'heroMovies={heroMovies}');
  code = code.replace(/setHeroMovie=\{setHeroMovies\}/g, 'setHeroMovies={setHeroMovies}');
