...
export const PLATFORMS: Record<string, PlatformConfig> = {
  ...
  paramount: { id: 'paramount', displayName: 'Paramount+', providerId: '2616', color: '#0064FF', logoPath: 'https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/paramount-plus-light.svg' },
  hulu: { id: 'hulu', displayName: 'Hulu', providerId: '15', color: '#1CE783', logoPath: 'https://upload.wikimedia.org/wikipedia/commons/e/e4/Hulu_Logo.svg' }
};
